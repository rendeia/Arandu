' ============================================================
'  Arandu - Iniciar (Arandu Mirim 1.2 por padrao)
'  Sem menu: garante o modelo Mirim 1.2 em modelo.txt e abre a IA.
...
' Modelo PADRAO: Arandu Mirim 1.2 (fine-tune proprio sobre Qwen3-1.7B)
modeloArq = "arandu-mirim-1.2-Q4_K_M.gguf"
