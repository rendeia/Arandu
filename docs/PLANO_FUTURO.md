...
| Família Katu (G2) | **Katu Mirim 2.1** (CPU/pendrive, Qwen3-1.7B em modo pensante) integrada ao chat; R1-Distill descartado p/ pt-BR; WebGPU 2.0 vira demo |
...
Katu ✅ raciocínio na edição CPU **2.1** (Qwen3-1.7B em modo pensante — mesmo
cérebro do Arandu, mas com `<think>` ligado; R1-Distill-1.5B foi testado e
descartado por pt-BR fraco); Vera/Taba ⚪ conceito.
